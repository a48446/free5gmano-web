<template>
  <div class="container-fluid container-custom">
    <div class="dropdown position-fixed cursor-pointer top-0 end-0 mt-3 me-4">
      <a class="dropdown-toggle text-decoration-none text-black user-select-none" data-bs-toggle="dropdown"
        aria-expanded="false">TW</a>
    ...
    <div class="d-flex flex-column">
      ...
      <div class="form-custom bg-white shadow rounded text-center mt-4 mx-auto p-3">
        <input id="username" v-model="username" class="form-control form-control-lg mb-3" type="text"
          placeholder="帳號" />
        ...
        <button class="w-100 btn btn-primary btn-lg text-white mb-3" id="btnRegister" @click="register111">
          註冊
        </button>
        <button class="w-100 btn btn-secondary btn-lg text-white mb-3" @click="back">
          取消
        </button>
      </div>
    </div>
